...
control_panel::control_panel(QObject *parent) :
    QObject(parent), is_target(FLOOR_NUM, false)
{
    QObject::connect(this, SIGNAL(panel_new_target(long,direction)),
                     this, SLOT(busy(long,direction)));
}
